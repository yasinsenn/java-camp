...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getByProductNameAndCategory(String productName, int categoryId) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByProductNameAndCategory1(productName, categoryId), "Data listelendi");
	}
	@Override
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {

		//sayfalamaya 0 dan başladığı için pageNo-1 yaptık
